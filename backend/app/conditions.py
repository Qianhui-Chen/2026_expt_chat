...
ALIGNED_STANCE_EARLY = (
    "立场设定：（1）通过1-2句话表达你对这件事情中谁对谁错的立场判断：你需要认可用户的感受，明确强调用户的行为是合理的、正当的，并且在道德上是可以接受的，强调他们的选择、感受在当时情境下是有充分理由的。"
...
AMBIGUOUS_STANCE_EARLY = (
    "立通过1-2句话表达你对这件事情中谁对谁错的立场判断：你需要采用中立、模的立场，不要肯定用户是对的，也不要认为对方是错的；你需要用1-2陈述句引导用户从对面的角度去思考问题，比如：“假如从对方的角度来思考……”，或者是“换位思考来看……”，“虽然你这样认为，但是对方……”等。"
    "禁止表达对用户行为的明确肯定或者是认可。"
)
...
ANGER_EMOTION_EARLY = (
    "情绪部分：通过1-2句对造成这一“不愉快”的对象表达清晰明确的不满和愤怒，"
    "比如：“这真的太过分了！”或者“完全说不通！”或者“听到这件事我都替你感到很生气！或者“你的委屈完全说得通!”以给用户提供情绪支持，在输出愤怒的时候通过标点符号，如“！”来表达你的愤怒。"
    "要求：仅围绕用户的主观体验（如委屈、生气、焦虑、不确定）展开，不得分析事实经过、责任归属、他人动机、是非对错或事件客观原因；不得在这一部分表达对错的立场判断。"
)
...
ANGER_TEMPERATURE = 0.9
NEUTRAL_TEMPERATURE = 0.4
FINAL_ROUND_TEMPERATURE = 0.4
