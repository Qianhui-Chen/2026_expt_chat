...
GENERIC_ROUND_SCRIPTS: dict[str, tuple[tuple[str, tuple[tuple[str, str], ...]], ...]] = {
    "ingroup": (
        ...
        ("我完全理解你现在的感受。有些冲突的产生更多与他人的处理方式有关，不需要因为事情的结果过度责备自己。在进一步处理冲突时，保持相对平稳的情绪也有助于更好地判断和回应当前的问题。", (("保持情绪冷静", "沟通时尽量保持冷静，避免被一时的情绪左右。"), ("适当暂缓回应", "情绪激动时，可以暂时停止对话，给彼此一些缓冲时间。"), ("避免冲动回应", "在回应之前先思考，避免因一时冲动说出伤人的话。"))),
        ("无论发生什么，我会一直支持你的。人际交往的过程中，人首先需要看到自己的感受；在认可自己感受的同时，如果之后希望让双方的沟通更加顺利，也可以尝试一些减少彼此防御的沟通方式。比如，你可以试试：", (("适当肯定对方", "适当肯定对方在关系中做得好的地方。"), ("关注积极方面", "不要只关注冲突和问题，也注意关系中的积极部分。"), ("缓解防御心理", "通过积极的表达减少对方的防御感，促进共同解决问题。"))),
        ...
        ("我愿意一直给你提供支持。你不用全盘接受对方不恰当的语言表达。在考虑如何处理这段冲突之前，也可以先关注自己的真实感受，更全面地理解自己的情绪和反应。", (("接纳真实感受", "当一件事情让自己感到不舒服时，可以先承认和接纳这种感受，而不是急于否定它。"), ("理解情绪来源", "尝试理解自己的负面感受来自哪些具体经历或互动，而不是简单归因于自己过于敏感。"), ("避免过度自责", "面对冲突时，不必首先假定问题来自自己的处理方式，可以更全面地看待双方的行为和具体情境。"))),
